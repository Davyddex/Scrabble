                        ...
                        if type(List_dictionnaire[élé]) == type([]):
                            ...
                            for élé2 in range(0, len(List_dictionnaire[élé])):
                                if élé2 != len(List_dictionnaire[élé]) - 1:
                                    str_list_int = str_list_int + str(List_dictionnaire[élé][
                                                                          élé2]) + '-'  # 'ZszS' sert à séparer les élément d'une liste qui est dans un dictionnaire lui-même dans une liste
                                else:
